...
# Read the CSV files
economic_df = pd.read_csv('economic_development.csv')
environmental_df = pd.read_csv('environmental_development.csv')
human_df = pd.read_csv('human_development.csv')
social_df = pd.read_csv('social_development.csv')
key_indicators_df = pd.read_csv('qatar_vision_key_indicators.csv')
